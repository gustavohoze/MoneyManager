...
struct LocalNotificationScheduler: NotificationScheduling {
    ...
    enum DebugNotificationKind: String, CaseIterable, Identifiable {
        ...
        var title: String {
            switch self {
            case .dailyWarning:
                return String(localized: "Daily spending check")
            case .budgetExceeded:
                return String(localized: "Budget reminder")
            case .weeklySummary:
                return String(localized: "Weekly spending summary")
            case .unusualSpending:
                return String(localized: "Spending anomaly check")
            }
        }
        ...
        var body: String {
            switch self {
            case .dailyWarning:
                return String(localized: "Debug test: daily warning notification.")
            case .budgetExceeded:
                return String(localized: "Debug test: budget exceeded notification.")
            case .weeklySummary:
                return String(localized: "Debug test: weekly summary notification.")
            case .unusualSpending:
                return String(localized: "Debug test: unusual spending notification.")
            }
        }
    }
    #endif
