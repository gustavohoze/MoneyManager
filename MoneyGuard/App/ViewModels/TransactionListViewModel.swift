...
final class TransactionListViewModel: ObservableObject {
    ...
    init(
        ...
        budgetProvider: CategoryBudgetProviding? = nil
    ) {
        self.dataProvider = dataProvider
        self.mutationService = mutationService ?? NoOpTransactionMutationService()
        self.optionsProvider = optionsProvider
        self.budgetProvider = budgetProvider ?? NoOpCategoryBudgetService()
